...
* ## [SSAM-zooplankton.ipynb](https://nbviewer.jupyter.org/github/SS-Atlantis/analysis-raisha/blob/main/Lovindeeretal-MPRI1paper/SSAM-zooplankton.ipynb)  
...
* ## [SSAM-phytos.ipynb](https://nbviewer.jupyter.org/github/SS-Atlantis/analysis-raisha/blob/main/Lovindeeretal-MPRI1paper/SSAM-phytos.ipynb)  
...
* ## [SSC-extract-plankton-biomass.ipynb](https://nbviewer.jupyter.org/github/SS-Atlantis/analysis-raisha/blob/main/Lovindeeretal-MPRI1paper/SSC-extract-plankton-biomass.ipynb)  
...
* ## [Spill-scenarios.ipynb](https://nbviewer.jupyter.org/github/SS-Atlantis/analysis-raisha/blob/main/Lovindeeretal-MPRI1paper/Spill-scenarios.ipynb)  
    ...
    **Salish Sea Oil Spill Scenarios**
    Point source spill scenarios were based on discussion with the Department of Fisheries and Oceans Canada (DFO) & Transport Canada.
    
    | **spill ID**  | **location** | **oil** | **spill size (m^3)** | **season** |
    |---------|---------|--------------------|------------|--------------|
    | 6a | English Bay, leaving Vancouver Harbour, at Anchorage| Bunker C| 15 | summer |
    | 4a | Active Pass | Diesel | 500 | summer |
    | 7a | Juan de Fuca Strait | Bunker C| 1000 | winter storm|
    | 5b | Turn Point, Arachne Reef |Dilbit | 2000 | winter |
