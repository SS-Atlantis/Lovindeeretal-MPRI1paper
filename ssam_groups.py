...
plankton = {
    'gelatinous zooplantkon':'Gelat_Zoo', 'microzooplankton':'MicroZoo', #'carnivorous zooplankton':'Carniv_Zoo', 
...
zooplankton = {
    'microzooplankton':'MicroZoo', 'gelatinous zooplantkon':'Gelat_Zoo', #'carnivorous zooplankton':'Carniv_Zoo', 
    'mesozooplankton':'Zoo',
}
...
all_pelagic = {
    ...
    'gelatinous zooplantkon':'Gelat_Zoo', #'carnivorous zooplankton':'Carniv_Zoo', 
...
longname = {
    ...
    'hake':'Hake','lingcod':'Lingcod', 'pollock':'Pollock', 'sandlance':'Sandlance', 'pacific herring':'Pacific_herring', 
    'Chinook':'Chinook_salmon', 'Chum':'Chum_salmon', 'Coho':'Coho_salmon','Pink':'Pink_salmon', 'Sockeye':'Sockeye_salmon', 
    'Hatchery Chinook':'Hatchery_Chinook_salmon','Hatchery Coho':'Hatchery_Coho_salmon','Hatchery Sockeye':'Hatchery_Sockeye_salmon', 
    'Other salmonids':'Other_salmonids',
    'small pelagic':'Small_pelagic_fish', 'rockfish':'Rockfish',
    ...
    'resident orcas':'Orcas_resident', 'transient orcas':'Orcas_transient', 'humpbacks':'Humpback_whales',
    'seagulls':'Seabird_gulls', 'other seabirds':'Seabirds',
    'Benthic_Carniv':'benthic carnivores', 'Deposit_Feeder':'deposit feeders', 'Meiobenth':'meiobenthos', 'Sed_Bact':'sedimentary bacteria',
     }
...
conditions = {
    '2019-01-14':'low Fraser neap tide', '2019-01-20':'low Fraser spring tide',
    '2020-01-16':'high Fraser neap tide', '2020-01-11':'high Fraser spring tide', 
    '2020-01-24':'high Fraser spring tide',
    '2019-01-26':'low Fraser neap tide', '2019-01-21':'low Fraser spring tide',
    '2020-01-03':'high Fraser neap tide',
    '2019-07-10':'low Fraser neap tide', '2019-07-16':'low Fraser spring tide', 
    '2020-07-12':'high Fraser neap tide', '2020-07-22':'high Fraser spring tide',
    '2019-07-25':'low Fraser neap tide', '2019-07-04':'low Fraser spring tide',
    '2020-07-13':'high Fraser neap tide', '2020-07-21':'high Fraser spring tide',
}
...
simulations = { 'low Fraser spring tide': 1, 'low Fraser neap tide':2,
                'high Fraser spring tide':3, 'high Fraser neap tide':4,
}
